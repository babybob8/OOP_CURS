...
void GeneralStudPerfBook::addStudent(const std::string& name)
{
    ...
    if (Config::CheckConditions)
        log_debug("Precondition check for addStudent [" + trimmed_name + "]: OK");

    m_scores[trimmed_name] = {};
    if (postconditionCheck())
    {
        if (Config::CheckConditions)
            log_debug("Postcondition check for addStudent [" + trimmed_name + "]: OK");
    }
    else
    {
        throw std::runtime_error("Postcondition violation for addStudent [" + trimmed_name + "].");
    }
}
...
void GeneralStudPerfBook::addWork(const std::string& name, double max_score, bool add_scores, bool mandatory, bool include_in_report)
{
    ...
    if (Config::CheckConditions)
        log_debug("Precondition check for addWork [" + trimmed_name + "]: OK");
    ...
    {
        if (Config::CheckConditions)
            log_debug("Postcondition check for addWork [" + trimmed_name + "]: OK");
    }
    else
    {
        throw std::runtime_error("Postcondition violation for addWork [" + trimmed_name + "].");
    }
}
               ...
               int attempt, std::string date, std::string notes)
{
    ...
    if (Config::CheckConditions)
        log_debug("Precondition check for addResult [" + trimmed_student + ", " + trimmed_work + "]: OK");
    ...
    {
        if (Config::CheckConditions)
            log_debug("Postcondition check for addResult [" + trimmed_student + ", " + trimmed_work + "]: OK");
    }
    else
    {
        throw std::runtime_error("Postcondition violation for addResult [" + trimmed_student + ", " + trimmed_work + "].");
    }
}
